  ...
  angular.module('angucomplete-alt', []).directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', '$interpolate', function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate) {
    ...
    function link(scope, elem, attrs, ctrl) {
      ...
      scope.$on('angucomplete-alt:getSetObjects', function (event, elementId) {
       ...
       scope.$on('angucomplete-alt:getItems', function () {
          return  removedItems;
      })
      ...
      function callOrAssign(value) {
         if(scope.listSelectedObject){
           ...
           if(typeof scope.newObjects == 'undefined') scope.newObjects = [];
        ...
        if (typeof scope.selectedObject === 'function') {
          scope.selectedObject(value, scope);
        }
        else {
